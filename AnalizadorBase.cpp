...
AnalizadorBase::AnalizadorBase(){}
AnalizadorBase::~AnalizadorBase() {}

void AnalizadorBase::cargarPalabras(const char* nombreArchivo) {
...
Palabra* AnalizadorBase::buscarEnVocabulario (const char* texto) const {
...
const char* AnalizadorBase::calcularSentimiento(int puntaje) const {
...
int AnalizadorBase::leerMensajes(const char* nombreArchivo, char frases[][200], int maxFrases) { // se pide un arreglo y un maxFrases
